...
<div x-data="{
      ...
      datePickerDayClicked(day) {
        if (this.selectingStartDate) {
          this.startDate = new Date(this.datePickerYear, this.datePickerMonth, day);
          this.selectingStartDate = false;
        } else {
          this.endDate = new Date(this.datePickerYear, this.datePickerMonth, day);
...
" x-cloak>
    <div class="container px-4 mx-auto">
        <div class="w-full mb-5">
            <label for="datepicker" class="block text-sm font-medium text-neutral-500 mb-2">{{ $label }}</label>
            <div class="relative w-[17rem]">
                ...
                <div
                    ...
                    class="z-50 absolute top-0 left-0 max-w-lg p-4 mt-12 antialiased bg-white border rounded-lg shadow w-[17rem] border-neutral-200/70">
