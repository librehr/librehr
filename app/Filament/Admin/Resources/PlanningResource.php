...
class PlanningResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Admin\Resources\PlanningResource\Pages\ListPlannings::route('/'),
            'create' => \App\Filament\Admin\Resources\PlanningResource\Pages\CreatePlanning::route('/create'),
            'edit' => \App\Filament\Admin\Resources\PlanningResource\Pages\EditPlanning::route('/{record}/edit'),
        ];
    }
}
